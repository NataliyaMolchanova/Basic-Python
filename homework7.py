...
#             print('Проверьте размерности матриц')
#             return None
#
...
#         print(f"Это новое пальто размера {self.param}")
#
#     @property
#     def get_consumption(self):
...
#     def __init__(self, param):
#         super().__init__(param)
#         print(f'Это новый костюм размера {self.param}')
#
#     @property
#     def get_consumption(self):
...
#
# my_coat = Coat(50)
# print(f'Расход для пальто {my_coat.get_consumption}')
# my_suit = Suit(1.78)
# print(f'Расход для костюма {my_suit.get_consumption}')
# print(f'Общий расход {my_coat.get_consumption + my_suit.get_consumption}')
...
#
#         else:
#             print('Substractions is impossible')
#
